...
[![NPM Package](https://img.shields.io/npm/v/eMarkcore-lib.svg?style=flat-square)](https://www.npmjs.org/package/eMarkcore-lib)
[![Build Status](https://img.shields.io/travis/bitpay/eMarkcore-lib.svg?branch=master&style=flat-square)](https://travis-ci.org/bitpay/eMarkcore-lib)
[![Coverage Status](https://img.shields.io/coveralls/bitpay/eMarkcore-lib.svg?style=flat-square)](https://coveralls.io/r/bitpay/eMarkcore-lib)
...
```
npm install eMarkcore-lib
```

```
bower install eMarkcore-lib
```
...
To get community assistance and ask for help with implementation questions, please use our [community forums](https://forum.deutsche-eMark.de/).
...
We're using eMarkcore in production, as are [many others](http://bitcore.io#projects), but please use common sense when doing anything related to finances! We take no responsibility for your implementation decisions.
...
To build a eMarkcore-lib full bundle for the browser:

```sh
gulp browser
```

This will generate files named `eMarkcore-lib.js` and `eMarkcore-lib.min.js`.

You can also use the pre-generated files, provided for each release along with a PGP signature by one of the project's maintainers. To get them, checkout a release commit (for example, https://github.com/bitpay/bitcore-lib/commit/e33b6e3ba6a1e5830a079e02d949fce69ea33546 for v0.12.6).
...
```sh
git clone https://github.com/Rumhocker/eMarkcore-lib
cd eMarkcore-lib
npm install
```
